...
export default function CollageEditor({initialFile=null,onSwitchField}){
  ...
  return <main className="shell">
    <aside className="panel left">
      <div className="brand" aria-label="1337tools"><span className="brand1337">1337</span><span className="brandTools">tools</span><small>4.0 / COMPOSE</small></div>{onSwitchField&&<button className="wide fieldBack" onClick={onSwitchField}>← FIELD</button>}
