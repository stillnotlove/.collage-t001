...
check(shell.includes('<span>4.35</span>'),'INDEX: version is not 4.35');
check((shell.match(/4\.35/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(css.includes('/* 4.35 — unify tool cards / reduce scale / preserve atmosphere */'),'VISUAL: 4.35 visual-system marker missing');
...
check(css.includes('border-radius:999px 999px 999px 2px'),'HUD: refined slider alternate thumb language missing');
...
check(pkg.version==='0.4.35','package.json: stale version');
