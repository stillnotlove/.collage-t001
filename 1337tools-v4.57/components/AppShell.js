...
function LogoWord({className=''}){
  return <div className={`brand systemBrand ${className}`}><span className="brand1337"><span className="brandOne brandDigit">1</span><span className="brand337"><span className="brandFirstThree brandDigit">3</span><span className="brandSecondThree brandDigit">3</span><span className="brandSeven brandDigit">7</span></span></span><span className="brandTools">tools</span></div>;
}
...
function IndexScreen({onOpen,onHome,onCredits}){
  ...
  return <main className="indexScreen indexMinimal catalogIndex" data-active={active.id}>
    <header className="minimalHeader"><Brand onClick={onHome}/><span>4.57</span></header>
...
function CreditsScreen({onBack,onHome}){
  return <main className="creditsScreen">
    ...
    <section className="creditsCenter">
      <div className="creditsTitle"><span className="creditsWordmark"><b className="credits1337"><span className="creditsOne brandDigit">1</span><span className="credits337"><span className="creditsFirstThree brandDigit">3</span><span className="creditsSecondThree brandDigit">3</span><span className="creditsSeven brandDigit">7</span></span></b><i className="creditsTools">tools</i></span> <span className="creditsBy">by</span> <a href="https://www.instagram.com/stillnotlove?igsi=MWYyZmVxZDVnbHR4aw%3D%3D&utm_source=qr" target="_blank" rel="noreferrer">.stillnotlove</a></div>
