...
check(shell.includes('<span>4.31</span>'),'INDEX: version is not 4.31');
check((shell.match(/4\.31/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(css.includes('/* 4.31 — stillnotlove editorial/new-ugly visual system */'),'VISUAL: 4.31 visual-system marker missing');
...
check(pkg.version==='0.4.31','package.json: stale version');
