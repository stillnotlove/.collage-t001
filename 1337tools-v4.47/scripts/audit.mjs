...
check(shell.includes('<span>4.47</span>'),'INDEX: version is not 4.47');
check((shell.match(/4\.47/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(visualAudit.includes('<span>4.47</span>'),'QA: static visual audit has stale version');
...
check(pkg.version==='0.4.47','package.json: stale version');
