...
check(shell.includes('<span>4.32</span>'),'INDEX: version is not 4.32');
check((shell.match(/4\.32/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(css.includes('/* 4.32 — pushed editorial / new-ugly poster system */'),'VISUAL: 4.32 visual-system marker missing');
...
check(pkg.version==='0.4.32','package.json: stale version');
