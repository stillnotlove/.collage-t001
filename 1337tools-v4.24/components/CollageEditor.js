...
export default function CollageEditor({initialFile=null,initialRatio='4 / 5',trail=[],onIndex,onHome}){
  ...
  return <main className="shell">
    <aside className="panel left">
      <button type="button" className="toolBrandHome" onClick={onHome} aria-label="Back to 1337tools home"><div className="brand"><span className="brand1337">1337</span><span className="brandTools">tools</span><small>4.24 / 04 EDITOR</small></div></button>{onIndex&&<button className="wide fieldBack" onClick={onIndex}>← INDEX</button>}
