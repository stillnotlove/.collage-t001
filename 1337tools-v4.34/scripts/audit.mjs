...
check(shell.includes('<span>4.34</span>'),'INDEX: version is not 4.34');
check((shell.match(/4\.34/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(css.includes('/* 4.34 — refined poster system / lighter atmosphere */'),'VISUAL: 4.34 visual-system marker missing');
...
check(pkg.version==='0.4.34','package.json: stale version');
