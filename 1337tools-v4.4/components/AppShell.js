...
function EntryScreen({onEnter}){
  return <main className="entryScreen entryMinimal" onPointerDown={onEnter} onKeyDown={e=>{if(!e.metaKey&&!e.ctrlKey&&!e.altKey)onEnter()}} role="button" tabIndex="0" aria-label="Enter 1337tools">
...
function IndexScreen({onOpen}){
  ...
  return <main className="indexScreen indexMinimal" data-active={active.id}>
    <header className="minimalHeader"><Brand/><span>4.3</span></header>
