...
check(shell.includes('<span>4.30</span>'),'INDEX: version is not 4.30');
check((shell.match(/4\.30/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(pkg.version==='0.4.30','package.json: stale version');
