...
check(shell.includes('<span>4.36</span>'),'INDEX: version is not 4.36');
check((shell.match(/4\.36/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(css.includes('/* 4.36 — remove residual yellow from SLICE card */'),'VISUAL: 4.36 visual-system marker missing');
...
check(pkg.version==='0.4.36','package.json: stale version');
