...
check(shell.includes('<span>4.28</span>'),'INDEX: version is not 4.28');
check((shell.match(/4\.28/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(pkg.version==='0.4.28','package.json: stale version');
