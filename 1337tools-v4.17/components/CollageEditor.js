...
export default function CollageEditor({initialFile=null,initialRatio='4 / 5',onIndex}){
  ...
  return <main className="shell">
    <aside className="panel left">
      <div className="brand" aria-label="1337tools"><span className="brand1337">1337</span><span className="brandTools">tools</span><small>4.17 / 04 EDITOR</small></div>{onIndex&&<button className="wide fieldBack" onClick={onIndex}>← INDEX</button>}
