...
check(shell.includes('<span>4.42</span>'),'INDEX: version is not 4.42');
check((shell.match(/4\.42/g)||[]).length===1,'INDEX: version should appear only once in AppShell');
...
check(pkg.version==='0.4.42','package.json: stale version');
