...
export default function CollageEditor(){
  ...
  function makeStamp(x,y,angle=0,order=1){
    ...
    if(stamp.type==='text')return {id:uid(),type:'text',text:stamp.text||'STAMP',x:px,y:py,width:clamp(stamp.size*scale,2,120),height:10*scale,rotation:rot,opacity,blend:'multiply',hidden:false,locked:false,order,color:'#111',fontFamily:'Arial Black, Arial, Helvetica, sans-serif',fontSize:58,fontWeight:700,tracking:0,lineHeight:.9,scaleX:1,scaleY:1,outline:0,outlineColor:'#111',outlineMode:'center'};
  ...
  return <main className="shell">
    <aside className="panel left">
      <div className="brand" aria-label="1337tools"><span className="brand1337">1337</span><span className="brandTools">tools</span><small>3.6.1</small></div>
