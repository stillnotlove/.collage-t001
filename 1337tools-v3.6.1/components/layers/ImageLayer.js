...
import {fx0,dotNoiseBackground,scratchBackground,grainBackground,halftoneBackground,xeroxBackground} from '../../lib/effects';
...
function ImageLayer({l}){
  ...
  return <div className="imageFrame" style={{borderRadius:`${l.radius||0}%`}}><img src={l.src} alt={l.name||''} draggable={false} style={{objectFit:l.fit||'cover',filter}}/><div className="fxMask" data-mask-src={l.src} style={mask}>
    ...
    {f.halftone>0&&<i className="fx proceduralFx" style={{opacity:f.halftone/115,backgroundImage:halftoneBackground(),mixBlendMode:'multiply'}}/>}
